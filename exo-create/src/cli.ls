...
function help
  ...
  Available entities are:
    ...
    * service       Create a new service for this application located in the parent directory
      - options: #{blue "--service-role=[<service-role>] --service-type=[<service-type>] --author=[<author>] --template-name=[<template-name>] --model-name=[<model-name>] --description[<description>]"}
  """
