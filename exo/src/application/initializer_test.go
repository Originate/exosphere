...
import (
	...
	"github.com/Originate/exosphere/exo/src/application"
	...
	"github.com/Originate/exosphere/exo/test_helpers"
...
var _ = Describe("Initializer", func() {
	It("should create a docker.compose.yml", func() {
		...
		initializer, err := application.NewInitializer(appConfig, mockLogger, "exo-run", appDir, homeDir)
		Expect(err).NotTo(HaveOccurred())
