...
base-path = path.dirname(process.mainModule.filename)
global.templates-path = path.join base-path, '../../exosphere-shared/templates'
global.example-apps-path = path.join base-path, '../../exosphere-shared/example-apps'
