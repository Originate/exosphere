...
func GetServiceBuiltDependencies(serviceConfig types.ServiceConfig, appConfig types.AppConfig, appDir string) map[string]AppDependency {
	appBuiltDependencies := GetAppBuiltDependencies(appConfig, appDir)
