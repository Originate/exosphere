...
func PullAllImages(dockerComposeLocation string, log func(string)) (*processHelpers.Process, error) {
...
func BuildAllImages(dockerComposeLocation string, log func(string)) (*processHelpers.Process, error) {
