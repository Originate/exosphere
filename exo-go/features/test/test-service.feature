Feature: testing an Exosphere service
  ...
  Scenario: testing a service
    Given I am in the "tweets-service" directory of the "tests-passing" example application
  ...
  Scenario: executing "exo test" in a directory that isn't a service or application
    Given I am in the root directory of an empty application called "empty"
